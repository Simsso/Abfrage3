...
$l['Date_difference_just_now'] = "A few seconds ago.";
$l['Date_difference_less_than_a_minute_ago'] = "Less than a minute ago.";
$l['Date_difference_a_minute_ago'] = "About a minute ago.";
$l['Date_difference_a_few_minutes_ago'] = "A few minutes ago.";
$l['Date_difference_less_than_an_hour_ago'] = "Less than an hour ago.";
$l['Date_difference_more_than_an_hour_ago'] = "More than one hour ago.";
...
$l['P_Math_tutorial__'] = "Abfrage3 supports Math symbols and equations. They look for example like that:<br><div>$\\sum_{i=0}^n i^2 = \\frac{(n^2+n)(2n+1)}{6}$</div>The corresponding code would be: <code>&dollar;\\sum_{i=0}^n i^2 = \\frac{(n^2+n)(2n+1)}{6}&dollar;</code><br>See <a href=\"http://meta.math.stackexchange.com/questions/5020/mathjax-basic-tutorial-and-quick-reference\" target=\"_blank\">MathJax basic tutorial and quick reference</a> for more information.";
...
$l['T_gave_you_permissions_to__'] = "<a href=\"#/user\">{{info.user.firstname}} {{info.user.lastname}}</a> gave you permissions to {{#if info.editingPermissions}}edit{{else}}view{{/if}} the list <a href=\"#/word-lists/{{info.list.id}}\">{{info.list.name}}</a>.";
$l['T_has_added_you__'] = "<a href=\"#/user\">{{info.firstname}} {{info.lastname}}</a> has added you.";
...
$l['T_user_has_added_words__'] = "<a href=\"#/user\">{{info.user.firstname}} {{info.user.lastname}}</a> has added {{info.amountString}} word{{#unless info.exactlyOneWord}}s{{/unless}} to {{#if info.yourList}}your{{else}}{{#if info.userAddedToTheirOwnList}}their{{else}}{{info.list_creator.firstname}}&#39;s{{/if}}{{/if}} list <a href=\"#/word-lists/{{info.list.id}}\">{{info.list.name}}</a>.";
...
$l['This_website_uses_cookies__'] = "This website uses cookies to ensure you get the best experience.";
